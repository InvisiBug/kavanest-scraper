# KavaNest Device Listener (Scraper)
![Cover Image](https://i.imgur.com/MPYJENV.png)

This is the `Device Listener` microservice of my KavaNest home automation system which is made up of the following components
...
* Device Listener (Scraper)
* [Devices](https://github.com/InvisiBug/Devices)

The device listener takes the data from the MQTT network, formats it and stores it in the mongo database. It also creates a websocket connection to the client that is used for push updates.
